...
if __name__ == '__main__':
    ...
    df_train = pd.read_csv("./data/train.csv", names=names22+names22_, header=0, index_col=False)
    ...
    df_val = pd.read_csv("./data/val.csv", names=names22, header=0, index_col=False)
    ...
    # test
    print("========================================================")
    df_test = pd.read_csv("./data/test.csv", names=names22, header=0, index_col=False)
